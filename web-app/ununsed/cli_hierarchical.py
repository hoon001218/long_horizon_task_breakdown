...
class HandoverTaskPlanner:
        ...
        if route.route_type == "direct_after_grip":
            ...
            return attach(
                [
                    ...
                    self._release(
                        rid, obj["id"], "Release the object inside its matching goal."
                    ),
                    self._homing(
        ...
        if route.route_type == "direct":
            ...
            return attach(
                [
                    ...
                    self._release(
                        rid, obj["id"], "Release the object inside the matching goal."
                    ),
                    self._homing(
                        rid, obj["id"], "Return the robot home after placing."
                    ),
    ...
    def _choose_shared_buffer_pose(
        ...
        center["z"] = float(center.get("z", DEFAULT_TABLE_CENTER["z"])) + float(0.03)
