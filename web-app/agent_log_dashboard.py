...
def main() -> None:
    ...
    metric_cols[5].metric("Violations", len(violations if selected_session == "<all>" else violations[violations["session_id"] == selected_session]))
    ...
    with tab_violations:
        ...
        if selected_session != "<all>":
            display_violations = display_violations[display_violations["session_id"] == selected_session]
